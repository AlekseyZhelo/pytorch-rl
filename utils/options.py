...
class Params(object):  # NOTE: shared across all modules
    def __init__(self):
        ...
        self.timestamp = "18021301"  # "yymmdd##"
...
class ModelParams(Params):  # settings for network architecture
    def __init__(self):
        ...
        if self.env_type == "minisim":
            self.num_robots = minisim_num_robots
            self.hist_len = 1
            self.hidden_dim = 32  # 56; 96; 128; 64
    ...
    def __init__(self):
        ...
        if self.agent_type == "dqn" and self.env_type == "gym":
            ...
            if self.env_type == "minisim":
                ...
                self.gamma = 0.99
                self.clip_grad = 40.
                self.lr = 5e-06  # 1e-04; 2e-05; 5e-05 for smaller conv
                self.icm_inv_lr = 0.0001
                self.icm_fwd_lr = 0.0001
                self.lr_decay = False
                self.weight_decay = 1e-4 if self.enable_continuous else 1e-6  # 1e-05
